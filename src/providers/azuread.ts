...
export const azureProvider: IProvider<Session> = {
    buildAuthorizeUrl() {
        return `https://login.microsoftonline.com/a3da1a5e-6af9-42be-8ad1-2a9b41101b90/oauth2/v2.0/authorize?response_type=id_token+token
        &scope=https%3A%2F%2Fgraph.microsoft.com%2Fuser.read%20openid%20profile
        &client_id=9a0ea2f6-9e35-48c6-9a50-89d5963ce0cd
        ...
        &login_hint=ruaan.venter@river-island.com
        &domain_req=${guid()}
        &login_req=${guid()}
